...
# ╔═╡ 9866ee7a-42be-11ef-2426-b332db2c669b
using WaterLily, StaticArrays

# ╔═╡ d076acaf-d1a5-4a64-b57b-710695bb4ac9
using PlutoUI

# ╔═╡ b7f4716b-4c48-4468-94dc-83707e3cae72
using Plots

# ╔═╡ 37be3938-2e14-4b4c-a221-4b3fd9b6495a
using GLMakie

# ╔═╡ 7baf762f-40a9-4cc4-a2e6-b9acc874e735
md"""

# Computational fluid dynamics


Computational Fluid Dynamics (CFD) is a powerful tool that uses numerical methods and algorithms to simulate and analyze the behavior of fluids (liquids and gases) under various conditions.  By solving the fundamental equations that govern fluid flow (like the Navier-Stokes equations), CFD provides valuable insights into phenomena that would be difficult, expensive, or even impossible to study through physical experiments alone.

Applications of CFD:

Aerospace: Design and optimization of aircraft and spacecraft
Automotive: Analysis of aerodynamics, engine cooling, and combustion
Energy: Design of wind turbines, analysis of oil and gas pipelines, simulation of nuclear reactors
Environmental: Prediction of pollutant dispersion, study of ocean currents, design of flood control systems
Manufacturing: Optimization of processes like mixing, casting, and injection molding
Medicine: Simulation of blood flow, analysis of respiratory systems

[WaterLily.jl](https://github.com/WaterLily-jl/WaterLily.jl/blob/master/examples/ThreeD_TaylorGreenVortex.jl) is a powerful Julia package that makes it easier to create and run CFD simulations. It leverages Julia's high-performance capabilities and provides a user-friendly interface for setting up and visualizing simulations.



"""

# ╔═╡ 14ed7cae-fa33-4488-81d5-afd491b1c5b5
md"## 2D: Flow around circle"

# ╔═╡ b6b8ca45-7003-4c2c-96b4-58494a3cedd8
...
# ╔═╡ 8540ad3c-3c0b-4a82-8eb6-549b91815b8c
circ = circle(3*2^6,2^7)

# ╔═╡ a361973d-4759-4e47-a800-edf1f96f653d
t_end = 10

# ╔═╡ 18ffa55f-e15a-45b1-8eaa-9218123f2bc1
sim_step!(circ,t_end)

# ╔═╡ c14a010a-ab85-4c26-b4b3-d380b725de97
md"Plotting functions in the hidden cell below:"

# ╔═╡ 234f639f-6181-4893-82d9-ebc8746304f6
begin
...
# ╔═╡ 2834e280-bc3b-4c99-8f54-f7b8952fa4d7
sim_gif!(circle(3*2^6,2^7),duration=20,clims=(-5,5),plotbody=true)

# ╔═╡ 6336a480-f018-4859-8576-2bfc37ee2a91
md"## 3D: Taylor Green Vortex"

# ╔═╡ d3d865a3-9996-4e0d-869e-7138a33e6a76
...
# ╔═╡ bf4aee17-c27d-4056-8f5e-38d2610eef1f
function TGV(p = 6, Re = 100_000, T=Float32, mem=Array)
...
# ╔═╡ c9e3cc53-6836-43aa-b4df-2661bb94dbe6
...
# ╔═╡ 35440790-79ff-411c-8e7b-a3e88de44750
md"Do 3D sim (5 min): $(@bind sim_tgv CheckBox())"

# ╔═╡ de42a9f3-a957-448a-8658-a7ada2952238
if sim_tgv
...
# ╔═╡ e3ecb314-4cb9-44be-90d5-4aa057c70e99
TableOfContents()
...
manifest_format = "2.0"
project_hash = "1792d30270249993ff8acc7772514a310b4d9145"
