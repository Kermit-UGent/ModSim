...
#> [frontmatter]
#> order = "28"
#> title = "6. Sensitivity intro"
#> date = "2025-08-06"
#> tags = ["exercises"]
#> description = "Sensitivity intro"
...
md"""
We are now ready to plot the two normalized sensitivity functions. We provide the time vector (first argument) and a vector of the two sensitivity functions (second argument). Additionally, you can provide a title, (legend) labels and a x- and/or y-label.
"""
