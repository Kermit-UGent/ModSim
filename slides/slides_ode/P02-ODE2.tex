...
$$
\vfill
In the numerical calculation, the variable $Y(t)$ changes in small steps. At every step, two terms are added:
\begin{enumerate}
...
\begin{itemize}
\item This method is a way to simulate the \textit{random}, \textit{discrete events} in a system that evolves through jumps (or reactions).
