...
# ╔═╡ df82156e-c268-4e0f-83ac-45a5dc77ea50
using Catalyst
...
md"
This notebook describes the syntax for building chemical reaction network models using Catalyst's domain-specific language (DSL). We will illustrate this by implementing and solving an infection model.
"
...
# ╔═╡ a146049b-2047-40e7-93d6-3d78c04b0a35
md"
##### Setting the timespan
"

# ╔═╡ 4e1e4e34-2eb2-4a8f-b1ed-6963ad8fad53
md"
...
# ╔═╡ 609c57b5-a888-4a07-884b-46871e905852
tspan = (0.0, 60.0)
...
# ╔═╡ f0e85300-eacd-45eb-87f6-dd19749524ed
md"
...
# ╔═╡ b13f393c-0a4b-4cc4-9130-2cee7c1d28e4
md"
To illustrate the simulation based on the Gillespie-algorithm, we will use the same infection model as before, with exactly the same initial conditions, parameter values and timespan.\
...
# ╔═╡ bec24c58-89b6-4dab-a167-f278ce964882
md"
...
# ╔═╡ ab8acd21-2a9f-4db0-8181-1efccc66a6fe
dprob = DiscreteProblem(infection_model, u0, tspan, params)

# ╔═╡ de777c75-ac50-4b3d-b8e3-283afde2d9d3
md"
...
# ╔═╡ 5a9716fa-a156-4672-ad9a-3935abae23b4
jprob = JumpProblem(infection_model, dprob, Direct())

# ╔═╡ d7e7797d-5e52-4550-b7dc-f09fc45945e1
md"
...
# ╔═╡ 5ab95dfb-a6c3-488a-b0e2-5dc76fbe10d1
dsol = solve(jprob, SSAStepper())

# ╔═╡ c718c623-dc4e-412f-8182-cdcaff583c09
md"
...
# ╔═╡ 5b148456-ac1d-41c8-8604-508e9ed3db11
size(dsol)

# ╔═╡ dca8dc65-78ea-48f3-8c99-dc8559afe175
plot(dsol)
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "468feedf1084a9f9a39a4ac5460f727722210327"
