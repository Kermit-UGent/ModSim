...
# ╔═╡ 2c29dd98-ad5e-11ef-1dfb-a79dcc9ccc8d
using Turing, Plots, PlutoUI, StatsPlots

# ╔═╡ 7af658ba-1d98-40f3-8cc5-db9106ea5e79
md"""
# Circleference

Write a small probabilistic program that can infer the center $x_C,y_C$ and radius $R$ of a circle given three (noisy) points $P_1=(x_1,y_1)$, $P_1=(x_2,y_2)$ and $P_3=(x_3,y_3)$. 

You can assume that the circle center can appear anywhere in the $[-20, 20]\times [-20, 20]$ and the radius is between 0 and 50. Points are sampled randomly on the circle and have a slight amount of Gaussian noise ($\sigma=0.25$ works well).

What if you condition on only one or two of the circle points?

"""

# ╔═╡ 275a9466-de53-40e0-a419-01320bf408d2
x1, y1 = 18.0, 2.1

# ╔═╡ a567ed5c-3919-4033-aff5-2d43f2374b3d
x2, y2 = -7.3, 8.1

# ╔═╡ 6accb5ed-5efc-47cd-b564-8b7f726b1cda
x3, y3 = -13., -23.0

# ╔═╡ f048f0a6-d9e3-43e8-989d-a0517c291131
...
# ╔═╡ 347680f6-b371-4dc9-9839-70915ffbd6c9
X, Y = [x1, x2, x3], [y1, y2, y3]

# ╔═╡ bc63835f-bf5e-4331-8f69-130b1e7d377b
circle1 = circle() | (x1=x1, y1=y1) 

# ╔═╡ 6df161c1-4e2d-4d48-be51-3fce7ea1ef6c
circle2 = circle1 | (x2=x2, y2=y2) 

# ╔═╡ 6836a709-e3ce-4564-b053-085afafbe278
circle3 = circle2 | (x3=x3, y3=y3) 

# ╔═╡ 80f5211d-9ada-4e68-84da-7efaed042f80
chain0 = sample(circle(), Prior(), 100);

# ╔═╡ 7f2fff6c-b2b7-41ae-8788-8f881aa2bf74
...
# ╔═╡ e017fc97-38f4-4337-8d84-022a9f1cc9f5
summarize(chain0)

# ╔═╡ 4cbdf561-4d91-4a2b-847a-f73419044a31
summarize(chain1)

# ╔═╡ bd15021b-974d-471e-ac93-9bce33e08197
summarize(chain2)

# ╔═╡ 365eae8a-2873-4bc5-9c8d-8e66fbf8f747
summarize(chain3)

# ╔═╡ 60f0fca6-64bb-4f83-8d64-78947fc78f57
@bind i Clock(max_value=100, repeat=true)

# ╔═╡ 09838db6-f6ca-4d56-b3f3-6c06adc23741
plot(chain0)

# ╔═╡ 33896389-9de2-4596-a3cd-69ac756e7808
plot(chain1)

# ╔═╡ cf95078b-8e47-4bd3-b919-91dab8d2e0ab
plot(chain2)

# ╔═╡ 55b897fe-553a-4c75-a313-c81c0175115e
plot(chain3)

# ╔═╡ d738b80e-bb1c-41ba-be9f-9e47c6982ff8
...
# ╔═╡ 5ece2d22-866c-4698-aca9-58c5682f9c0e
...
# ╔═╡ ed6bf15b-6437-4a6c-be13-b2f5a265e410
plotsample()

# ╔═╡ 75d10b0d-4dcb-439d-bdf2-0911866f5e19
plotsample(chain0[:R][i], chain0[:xC][i], chain0[:yC][i], title="Sample of P(circle)")

# ╔═╡ babd0c48-cc88-41ab-b107-c455b18eea00
plotsample(chain1[:R][i], chain1[:xC][i], chain1[:yC][i], title="Sample of P(circle|P1)")

# ╔═╡ 39f74de7-5cfc-4d62-98c7-00670fbe7f60
plotsample(chain2[:R][i], chain2[:xC][i], chain2[:yC][i], title="Sample of P(circle|P1, P2)")

# ╔═╡ ff807c0f-f5a8-4c50-b930-84f34c49966b
plotsample(chain3[:R][i], chain3[:xC][i], chain3[:yC][i], title="Sample of P(circle|P1, P2, P3)")
...
manifest_format = "2.0"
project_hash = "700692e8809028dc3f6b04a1ab860245a61072c7"
