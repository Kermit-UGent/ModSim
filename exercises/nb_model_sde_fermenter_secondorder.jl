...
Hint: pay attention to how many net *reactions* there are, this corresponds to the number of noise scaling parameters. Use the parameter names `η1`, `η2`, ... for them.
"
...
# ╔═╡ 12da361b-53b5-4c4f-87b3-be0aff224b5a
md"
Initialize a vector `params` with the parameter values.\
Assign the following noise scaling values:
- `η1 = 0.10` for the *reaction* `k*X, S --> Y*X`
- `η2 = 0.05` for the *reaction* `Q/V*Sin, 0 --> S`
- `0.0` for the remaining noise scaling parameters
"
...
- Don't forget to mention the noise scaling parameters.
"
