...
md"""
Solve the ODE problem for (step wise) increasing values of $v$ and store the solution in `osol_ex3_no_vac`. Consider an initial step size in $v$ of $0.01$ and then fine tune with a step size of $0.001$.
"""
