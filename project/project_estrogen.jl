...
md"""
Note: This project is an adaption of [the following blog post](https://www.oxinabox.net/2022/11/11/Estimating-Estrogen.html) by Dr. Frames Catherine White. Students are (sadly) not permitted to adapt existing blog posts for their own projects.
"""
...
p_data = scatter(t_obs, c_obs, color = color_palette, bg = :gray, label = ["A200 obs" "A400 obs" "Amax obs"], xlabel = "t (h)", ylabel = "Estrogen concentration (pg/ml)")
...
manifest_format = "2.0"
project_hash = "83b2195615fbc0a97d9704b023903c67aca6bb6f"
...
git-tree-sha1 = "a8fa0ee091a2f83a7a1019c6875d6eda18f332cf"
...
git-tree-sha1 = "3034517583c9b517f8e927c2ab923a9c08649e39"
